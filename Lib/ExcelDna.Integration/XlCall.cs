...
namespace ExcelDna.Integration
{
	public class XlCall
	{
		...
		*/
        ...
        public static readonly int xlfAcot = 548;
        public static readonly int xlfAcoth = 549;
        public static readonly int xlfCot = 550;
        public static readonly int xlfCoth = 551;
        public static readonly int xlfCsc = 552;
        public static readonly int xlfCsch = 553;
        public static readonly int xlfSec = 554;
        public static readonly int xlfSech = 555;
        public static readonly int xlfImtan = 556;
        public static readonly int xlfImcot = 557;
        public static readonly int xlfImcsc = 558;
        public static readonly int xlfImcsch = 559;
        public static readonly int xlfImsec = 560;
        public static readonly int xlfImsech = 561;
        public static readonly int xlfBitand = 562;
        public static readonly int xlfBitor = 563;
        public static readonly int xlfBitxor = 564;
        public static readonly int xlfBitlshift = 565;
        public static readonly int xlfBitrshift = 566;
        public static readonly int xlfPermutationa = 567;
        public static readonly int xlfCombina = 568;
        public static readonly int xlfXor = 569;
        public static readonly int xlfPduration = 570;
        public static readonly int xlfBase = 571;
        public static readonly int xlfDecimal = 572;
        public static readonly int xlfDays = 573;
        public static readonly int xlfBinom_dist_range = 574;
        public static readonly int xlfGamma = 575;
        public static readonly int xlfSkew_p = 576;
        public static readonly int xlfGauss = 577;
        public static readonly int xlfPhi = 578;
        public static readonly int xlfRri = 579;
        public static readonly int xlfUnichar = 580;
        public static readonly int xlfUnicode = 581;
        public static readonly int xlfMunit = 582;
        public static readonly int xlfArabic = 583;
        public static readonly int xlfIsoweeknum = 584;
        public static readonly int xlfNumbervalue = 585;
        public static readonly int xlfSheet = 586;
        public static readonly int xlfSheets = 587;
        public static readonly int xlfFormulatext = 588;
        public static readonly int xlfIsformula = 589;
        public static readonly int xlfIfna = 590;
        public static readonly int xlfCeiling_math = 591;
        public static readonly int xlfFloor_math = 592;
        public static readonly int xlfImsinh = 593;
        public static readonly int xlfImcosh = 594;
        public static readonly int xlfFilterxml = 595;
        public static readonly int xlfWebservice = 596;
        public static readonly int xlfEncodeurl = 597;
